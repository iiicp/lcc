 ...
 */
    ...
    TokenStream<PPToken> tokenize(std::string_view filePath, llvm::raw_ostream *reporter, bool *errors) {
    }
    TokenStream<PPToken> tokenize(const std::string &source, llvm::raw_ostream *reporter, bool *errors, std::string_view path) {
    }
    TokenStream<CToken> toCTokens(TokenStream<PPToken> &&ppTokenStream, llvm::raw_ostream *reporter, bool *errors) {
    }
    TokenStream<CToken> toCTokens(const TokenStream<PPToken> &ppTokenStream, llvm::raw_ostream *reporter, bool *errors) {
    }
}// namespace lcc::lexer
