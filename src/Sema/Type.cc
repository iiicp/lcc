...
Type PrimitiveType::create(bool isConst, bool isVolatile,
                           PrimitiveType::Kind kind) {
  return Type(isConst, isVolatile, PrimitiveType(kind));
}
...
Type PointerType::create(bool isConst, bool isVolatile, bool restricted,
                         Type elementType) {
  return Type(
      isConst, isVolatile,
      PointerType(restricted, std::make_shared<Type>(std::move(elementType))));
}
...
Type FunctionType::create(Type returnType, std::vector<Argument> &&arguments,
                          bool lastIsVararg) {
